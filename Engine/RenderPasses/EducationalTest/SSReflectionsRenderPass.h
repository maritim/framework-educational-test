#ifndef SSREFLECTIONSRENDERPASS_H
#define SSREFLECTIONSRENDERPASS_H

#include "RenderPasses/PostProcess/PostProcessRenderPass.h"

class ENGINE_API SSReflectionsRenderPass : public PostProcessRenderPass
{
	DECLARE_RENDER_PASS(SSReflectionsRenderPass)
